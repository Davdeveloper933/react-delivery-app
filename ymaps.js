(function ymapsInit(e) {
	...
	(t.modules = new o({
		...
		fetchBundle: function (e) {
			...
			(o.src = t.env.hosts["static"] + t.env.bundles[e]),
				...
				o.setAttribute("data-ymaps-api-version", "2.1.79-12002154"),
				(o.async = !0);
			var i = t.vow.defer();
			return (
	...
	enterprise: false,
	bundles: {
		full: "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-12002154/build/release/full-70275b62ece2fd2ab62f973df06797d58e0c96b5.js",
	},
	version: "2.1.79",
	tag: "2.1.79-12002154",
	...
	server: {
		...
		path: "build/release",
		params: { apikey: "c855cd27-9a6e-4881-8033-7e9d43b009cc", csp: null },
		version: "2.1",
	},
	preload: { load: "package.full", bundle: "full" },
	token: "a4de2d4202b2d98d053b5ffcce0aff0a",
	taxiInceptionBboxes: [
		[
	...
	apikey: "c855cd27-9a6e-4881-8033-7e9d43b009cc",
	apikeyValid: true,
	browser: {
		name: "Chrome",
		version: "114.0.0.0",
	...
	vector: { version: "5.21.0", ts: 1690221795717 },
	hosts: {
		api: {
	...
	layers: {
		...
		sat: { version: "3.1082.0" },
		sta: { version: "2023.07.24.17.30-1_23.07.24-0-15460" },
		stv: { version: "2023.07.24.17.30-1_23.07.24-0-15460" },
		trf: { version: "1690221780", scaled: true },
	...
	geolocation: {
		...
		span: { longitude: 0.258957, latitude: 0.176095 },
	},
});
